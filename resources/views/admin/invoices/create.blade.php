              ...
              <div class="card-body">
                ...
                <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                  ...
                  <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Product Name" required="" name ="name" id ="name" value ="{{ old('name') }}">
                  ...
                  <div class="form-group {{ $errors->has('discpline_name') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Discpline Name" required="" name ="discpline_name" id ="discpline_name" value ="{{ old('discpline_name') }}">
                  ...
                  <div class="form-group {{ $errors->has('group') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Group" required="" name ="group" id ="group"  value ="{{ old('group') }}">
                  ...
                  <div class="form-group {{ $errors->has('sub_group') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Sub Group" required="" name ="sub_group" id ="sub_group" value ="{{ old('sub_group') }}">
                  ...
                  <div class="form-group {{ $errors->has('test_performed') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Specified Test Performed" required="" name ="test_performed" id ="test_performed" value ="{{ old('test_performed') }}">
                  ...
                  <div class="form-group {{ $errors->has('test_method') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Test Method" required="" name ="test_method" id ="test_performed" value ="{{ old('test_method') }}">
                  ...
                  <div class="form-group {{ $errors->has('range_test_detection') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Range of Testing/Limit of detection" required="" name ="range_test_detection" id ="range_test_detection" value ="{{ old('range_test_detection') }}">
                  ...
                  <div class="form-group {{ $errors->has('mu_value') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter MU Value" required="" name ="mu_value" id ="mu_value" value ="{{ old('mu_value') }}">
                  ...
                  <div class="form-group {{ $errors->has('test_status') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Test Status" required="" name ="test_status" id ="test_status" value ="{{ old('test_status') }}">
