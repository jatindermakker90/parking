              ...
              <div class="card-body row col-12">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group {{ $errors->has('company_name') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Company Name" name ="company_name" id ="company_name" value ="{{ old('company_name')??$user->company_name}}">
                  ...
                  <div class="form-group {{ $errors->has('phone_number') ? 'has-error' : '' }}">
                    ...
                    <input type="hidden" class="form-control" name ="country" id ="user_country" value="{{$user->country}}">
                  ...
                  <div class="form-group {{ $errors->has('city') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter City" required="" name ="city" id ="city" value ="{{ old('city')??$user->city}}">
                ...
                <div class="col-sm-6">
                   <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Person Name" name ="name" id ="name" value ="{{ old('name')??$user->name}}">
                  ...
                  <div class="form-group {{ $errors->has('landline') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Landline Number" name ="landline" id ="landline" value ="{{ old('landline')??$user->landline}}">
                  ...
                  <div class="form-group {{ $errors->has('pan_number') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Pan number" required="" name ="pan_number" id ="pan_number" value ="{{ old('pan_number')??$user->pan_number}}">
                  ...
                  <div class="form-group {{ $errors->has('gst_number') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter GST number" required="" name ="gst_number" id ="gstin" value ="{{ old('gst_number')??$user->gst_number}}">
                  ...
                  <div class="form-group {{ $errors->has('street_address') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Company Address" required="" name ="street_address" id ="street_address" value ="{{ old('street_address')??$user->street_address}}">
                   ...
                   <div class="form-group {{ $errors->has('zipcode') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Zipcode" required="" name ="zipcode" id ="zipcode" value ="{{ old('zipcode')??$user->zipcode}}">
