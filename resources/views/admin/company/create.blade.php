              ...
              <div class="col-sm-6">
                ...
                <div class="form-group {{ $errors->has('company_title') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Company Title"
                        name="company_title" id="company_title" value="{{ old('company_title') ?? '' }}">
                ...
                <div class="form-group {{ $errors->has('short_notes') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Short Notes" r
                        name="short_notes" id="short_notes" value="{{ old('short_notes') ?? '' }}">
              ...
              <div class="col-sm-6">
                  ...
                  <div class="form-group {{ $errors->has('sku_tag') ? 'has-error' : '' }}">
                      ...
                      <select class="form-control select2" style="width: 100%;" name="sku_tag" id="sku_tag"
                          ...
                          <option value="apl">Apl (Airport Parking Luton)</option>
                          <option value="atp">Atp (Airport Tavern Parking)</option>
                          <option value="gpm">Gpm (Global Parking Management)</option>
                          <option value="maple">Maple (Maple Manner)</option>
                          <option value="oakwood">Oakwood (Oakwood Airport Parking)</option>
                      </select>
                  ...
                  <div class="form-group {{ $errors->has('price_plan') ? 'has-error' : '' }}">
                      ...
                      <select class="form-control select2" style="width: 100%;" name="price_plan"
                          ...
                          @foreach (config('constant.PRICE_PLAN') as $price_plan_key => $price_plan_value)
                            <option value="{{ $price_plan_key }}">{{ $price_plan_value }}</option>
                          @endforeach
                      </select>
                      ...
                      <div class="form-group file-input">
                          <div id="fileUploadphoto" class="wpforms-uploader dropzone-single" data-field-id="32"
                              ...
                              <div class="dz-message">
                                  ...
                                  <span class="file-uplod"><img src="/assets/images/file.png"
                                          alt="">Upload Company Logo</span>
                              </div>
                ...
                <div class="form-group">
                  <div class="checkbox">
                    @foreach ($offer_type as $offer_type_key => $offer_type_value)
                      <div class="checker">
                        <span>
                          <input type="checkbox" name="offer_types[{{$offer_type_key}}]" value="{{$offer_type_value->id}}">
                        </span>
                ...
                <div class="form-group">
                  <div class="checkbox">
                    @foreach ($company_type as $company_type_key => $company_type_value)
                      <div class="checker">
                        <span>
                          <input type="checkbox" name="company_types[{{$company_type_key}}]" value="{{$company_type_value->id}}">
                        </span>
                ...
                <div class="form-group">
                  <div class="checkbox">
                    @foreach ($service_type as $service_type_key => $service_type_value)
                      <div class="checker">
                        <span>
                          <input type="checkbox" name="service_types[{{$service_type_key}}]" value="{{$service_type_value->id}}">
                        </span>
            ...
            <div class="row col-12">
              <div class="col-2">
                <div class="checkbox">
                  <div class="checker">
                    <span>
                      <input type="checkbox" name="send_csv" value="1">
                    </span>
                    Send CSV
                  </div>
                </div>
              ...
              <div class="col-2">
                <div class="checkbox">
                  <div class="checker">
                    <span>
                      <input type="checkbox" name="add_extra_amount" value="1">
                    </span>
                    Add Extra Amount
                  </div>
                </div>
              ...
              <div class="col-2">
                <input type="number" class="form-control m-t-xxs" id="extra_amount" name="extra_amount" placeholder="Enter Amount">
              </div>
              <div class="col-2">
                <div class="checkbox">
                  <div class="checker">
              ...
              <div class="col-2">
                <input type="number" class="form-control m-t-xxs" id="levy_charge" name="levy_charge" placeholder="Enter levy charge">
              </div>
            </div>
