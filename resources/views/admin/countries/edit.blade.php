              ...
              <div class="card-body">
                ...
                <form method="POST" action="{{ route('countries.update',[$country->id]) }}" enctype="multipart/form-data">
                   ...
                   <div class="form-group {{ $errors->has('country') ? 'has-error' : '' }}">
                    ...
                    <option value ="{{ $countries_value->name->common }}" <?php echo strtolower($country->country) ==  strtolower($countries_value->name->common) ? 'selected' : '' ?> >{{ $countries_value->name->common }}</option>
                    @endforeach
                    </select>
                  ...
                  <div class="form-group {{ $errors->has('country') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Country Iso Code" required="" name ="country_iso_code" id ="country_iso_code" value ="{{ old('country_iso_code')??$country->country_iso_code }}">
                  ...
                  <div class="form-group {{ $errors->has('country') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Country Code" required="" name ="country_code" id ="country_code" value ="{{ old('country_code')??$country->country_code }}">
                  ...
                  <div class="form-group {{ $errors->has('country') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Currency" required="" name ="currency" id ="currency"  value ="{{ old('currency')??$country->currency }}">
                  ...
                  <div class="form-group {{ $errors->has('country') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Language Iso Code" required="" name ="language_iso_code" id ="language_iso_code" value ="{{ old('language_iso_code')??$country->language_iso_code }}">
                  ...
                  <div class="form-group {{ $errors->has('country') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Language" required="" name ="language" id ="language" value ="{{ old('language')??$country->language }}">
