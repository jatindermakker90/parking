                  ...
                  <div class="tab-content" id="myTabContent" style="padding: 20px;background: white;">
                    ...
                    <div class="tab-pane fade" id="term" role="tabpanel" aria-labelledby="term-tab">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                             <textarea class="summernote" name="term_condition_box" id="term_condition_box" style="display: none;">@if(isset($term_condition_setting->term_condition_box)) {{$term_condition_setting->term_condition_box}} @endif </textarea>
                          </div>
                        </div>
                      </div>
                      <br><hr><br>
