              ...
              <div class="card-body">
                ...
                <form method="POST" action="{{ route('airport.store') }}" enctype="multipart/form-data">
                  ...
                  <div class="form-group {{ $errors->has('airport_name') ? 'has-error' : '' }}">
                    <label for="airport_name">Page Name</label>
                    <input type="text" class="form-control"  placeholder="Enter Page Name" required="" name ="airport_name" id ="airport_name"  value ="{{ old('airport_name') }}">
                  ...
                  <div class="form-group {{ $errors->has('operating_location') ? 'has-error' : '' }}">
                    <label for="airport_name">Page Title</label>
                    <input type="text" class="form-control"  placeholder="Enter Page Title" required="" name ="operating_location" id ="operating_location"  value ="{{ old('operating_location') }}">
