...
<div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label for="search_type">Bookings Type:</label>
                    <select class="form-control select2" name ="search_type" id ="search_type">
                    <option value="">All</option>
                    <option value="">Normal Bookings</option>
                    <option value="">Discounted Bookings</option>
                </select>
                </div>
            </div>
            <div class="col-md-4">
...
<div class="row">
  ...
  <div class="col-sm-4">
    <div class="rev" style="padding: 40px;border: 1px solid rgba(56, 67, 78, 0.25);;">
      <h6 style="margin-bottom: 10px;"><strong id="bookings">Total Bookings : {{ $total_booking }}</strong></h6>
      <h6><strong id="sum">Total Amount: £ {{ $total_amount }}</strong></h6>
    </div>
  </div>
</div>
...
<script type="text/javascript">
 $(document).ready(function(){
    $('#data_collection').DataTable({
      ...
      "ajax"        :"{{ url('admin/booking/booking-revenue-list') }}",
      "columns"     : [
            {
              data: 'airport_name',         
              name: 'airport_name',   
