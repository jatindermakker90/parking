          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form method="POST" action="{{ route('terminals.update',[$terminal->id]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <input type="text" class="form-control"  placeholder="Enter Terminal Name" required="" name ="terminal_name" id ="terminal_name"  value ="{{ $terminal->terminal_name ?? old('terminal_name') }}">
                  ...
                  <div class="form-group {{ $errors->has('airport_id') ? 'has-error' : '' }}">
                    ...
                    <option value ="{{ $airport_value->id }}" <?php echo $airport_value->id ==  $terminal->airport_id ? 'selected' : '' ?>>{{ $airport_value->airport_name }}</option>
                    @endforeach
                    </select>
