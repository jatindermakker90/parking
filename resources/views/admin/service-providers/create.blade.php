              ...
              <div class="card-body row col-12">
                 <div class="col-sm-6">
                  ...
                  <div class="form-group {{ $errors->has('first_name') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control"  placeholder="Enter First Name" required="" name ="first_name" id ="first_name" value ="{{ old('first_name')??''}}">
                 ...
                 <div class="col-sm-6">
                    ...
                    <input type="password" class="form-control"  placeholder="Enter Password" required="" name ="password" id ="password" value ="{{ old('password')??''}}">
